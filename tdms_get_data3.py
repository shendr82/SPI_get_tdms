...
from nptdms import TdmsFile      # 1.3.1 version
import numpy as np
...
class SPI_tDMS_Data(object):
    ...
    # tDMS file - location
file = 'C:\\ShendR\\Python\\SPI tDMS\\TDMS files\\20211006_150719_MonitorData.tdms'    
...
plot_one_channel = spi_data.plot_one_channel(3000,5000)
